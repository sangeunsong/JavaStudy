 ...
 *               -----한개(배열,클래스)
 *       *인스턴스 메소드=>인스턴스메소드 호출,인서턴스 변수,static변수,static메소드=>사용이 가능
 ...
 *        -------------------------
 *      2)매개 변수의 개수가 다르다,매개 변수의 데이터형이 다르다         
 *                 -----------          -------------  
 *      3)리턴형은 관계없다
 *        -------------
 *      
...
public class 오버로딩_1 {
	...
	public static void main(String[] args) {
		...
		오버로딩_1 a=new 오버로딩_1();
		//a.display(10.0F, 10, 10); 매개변수는 작거나 같은 것
	}
